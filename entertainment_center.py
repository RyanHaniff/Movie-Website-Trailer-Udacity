...
# Storing Movie objects as an array to be passed into the open_movies_page method
movies = [the_shawshank_redemption, iron_man, the_pursuit_of_happyness, rush, thor, the_avengers]
